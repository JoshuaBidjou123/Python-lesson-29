-- Create the NOBEL_WIN if it does not exist
...
-- Insert smaple data into the NOBEL_WIN table
INSERT INTO NOBEL_WIN ( YEAR, SUBJECT, WINNER, COUNTRY, CATEGORY) VALUES
(1970, 'PHYSICS', 'HANNER ALFVEN','SWEDEN', 'SCIENTIST'),
...
(1972, 'ECONOMICSS', 'JOSEPH', 'RUSSIA', 'ECONOMIST'),
...
-- Select all records from the NOBEL_WIN where the subject does not start with 'P'
SELECT*
FROM NOBEL_WIN
